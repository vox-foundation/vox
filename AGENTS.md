...
- `docs/src/SUMMARY.md` — **No longer committed.** The Starlight sidebar is now built from frontmatter directly by `docs-astro/src/utils/sidebar.mjs` at build time. Do not create or edit this file.
- `docs/src/feed.xml` — RSS feed. Now generated by the Astro `@astrojs/rss` endpoint at build time; **not committed**.
