...
/// Returns the base URL for the VoxLocal inference server (default: `http://127.0.0.1:11434`).
fn vox_local_base_url() -> String {
    std::env::var("VOX_LOCAL_ENDPOINT").unwrap_or_else(|_| "http://127.0.0.1:11434".to_string())
}
