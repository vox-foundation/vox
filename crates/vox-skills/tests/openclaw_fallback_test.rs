...
async fn test_execute_skill_deny_by_default() {
    use serde_json::json;
    use std::sync::Arc;
    use vox_ars_runtime::domain::ArsSkill;
    use vox_ars_runtime::runtime::{ArsRuntime, ArsRuntimeError};
    ...
    let hooks = Arc::new(vox_ars_runtime::hooks::HookRegistry::new());
    ...
    let skill = ArsSkill {
        ...
        author: None,
        body: None,
        kind: vox_ars_runtime::manifest::SkillKind::Tool,
        trust: vox_ars_runtime::manifest::TrustLevel::Trusted,
        resource_limits: vox_ars_runtime::manifest::ResourceLimits::default(),
        metadata: json!({
