...
const LEXER_KEYWORDS: &[&str] = &[
    "fn", "let", "mut", "if", "else", "match", "for", "in", "to", "return", "while", "loop", "break", "continue", "type", "import", "actor", "workflow", "activity", "spawn", "http", "pub", "with", "on", "state", "derived", "effect", "mount", "cleanup", "view", "component", "and", "or", "not", "is", "isnt", "true", "false", "get", "post", "put", "delete",
];

const LEXER_DECORATORS: &[&str] = &[
    "@deprecated", "@mcp.tool", "@mcp.resource", "@pure", "@require", "@scheduled", "@ensure", "@invariant", "@forall", "@fuzz", "@test", "@server", "@query", "@mutation", "@table", "@index", "@v0", "@mobile.native", "@island", "@loading",
];
