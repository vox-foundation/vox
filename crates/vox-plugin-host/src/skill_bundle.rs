...
//!
//! Moved from `vox-skills::bundle`. `vox-skills` re-exports these from here.
//!
...
/// Parse error for skill bundles/manifests.
...
impl VoxSkillBundle {
    ...
    pub fn to_json(&self) -> Result<String, SkillBundleError> {
        Ok(serde_json::to_string_pretty(self)?)
    }

    /// Deserialize a bundle from JSON.
    pub fn from_json(json: &str) -> Result<Self, SkillBundleError> {
