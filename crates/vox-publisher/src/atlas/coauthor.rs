...
impl CreditRole {
    pub fn as_uri(&self) -> &'static str {
        match self {
            Self::Conceptualization => "https://credit.niso.org/contributor-roles/conceptualization/",
            ...
            Self::FundingAcquisition => "https://credit.niso.org/contributor-roles/funding-acquisition/",
            ...
            Self::ProjectAdministration => "https://credit.niso.org/contributor-roles/project-administration/",
            ...
            Self::WritingOriginalDraft => "https://credit.niso.org/contributor-roles/writing-original-draft/",
            Self::WritingReviewEditing => "https://credit.niso.org/contributor-roles/writing-review-editing/",
        }
    }
}
...
mod tests {
    ...
    fn credit_role_uris_are_niso() {
        assert!(CreditRole::Conceptualization.as_uri().contains("credit.niso.org"));
