...
impl CloudResolver {
    ...
    ///
    /// - `gpu_specs_path`: path to `populi/config/gpu-specs.yaml`
    ...
    pub async fn new_from_env() -> anyhow::Result<Self> {
        ...
        let specs_path = root.join("populi/config/gpu-specs.yaml");
...
pub fn build_train_spec(
    ...
    CloudJobSpec {
        model_id: model_id.unwrap_or_else(|| crate::DEFAULT_MODEL_ID.to_string()),
