...
pub enum Mood {
    /// Companion is happy; high code quality.
    Happy,
    /// Companion is calm and balanced.
    Neutral,
    /// Companion is unhappy; low code quality or repeated failures.
    Sad,
    /// Companion is energised after a success or play interaction.
    Excited,
    /// Companion needs rest; energy is depleted.
    Tired,
}
...
pub enum Personality {
    #[default]
    /// Upbeat and enthusiastic; strong positive reactions.
    Cheerful,
    /// Analytical and goal-oriented; neutral tone.
    Focused,
    /// Cynical and dry; minimal positive expressions.
    Edgy,
    /// Thoughtful and philosophical; reflective tone.
    Wise,
    /// Quirky and unusual; creative expressions.
    Quirky,
}

impl Personality {
    /// Convert this personality to its canonical lower-case slug.
...
pub struct Companion {
    ...
    /// Hash of the associated source code file, used to detect drift.
    pub code_hash: Option<String>,
    /// Primary programming language (e.g. `"vox"`, `"rust"`).
    pub language: String,
    /// ASCII art sprite (regenerated from mood on each interaction).
    pub ascii_sprite: Option<String>,
    /// Current emotional state.
    pub mood: Mood,
    /// Current health points (0–max_health).
    pub health: i32,
    /// Maximum health points.
    pub max_health: i32,
    /// Current energy points (0–max_energy).
    pub energy: i32,
    /// Maximum energy points.
    pub max_energy: i32,
    /// Code quality score (0–100) driving mood updates.
    pub code_quality: u8,
    /// Unix timestamp of the last interaction.
    pub last_active: i64,
    /// Personality archetype governing reaction text.
    #[serde(default)]
