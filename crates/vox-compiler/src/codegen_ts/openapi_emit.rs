...
fn struct_schema(fields: &[crate::contract_ir::ContractField]) -> Value {
...
mod tests {
    use super::*;
    use crate::contract_ir::{ContractField, ContractType, ContractTypeKind, WireType};
    ...
    fn query_endpoint_uses_get_with_query_params() {
        let ir = ContractIr {
            ...
            endpoints: vec![ContractEndpoint {
                kind: crate::contract_ir::ContractEndpointKind::Query,
    ...
    fn mutation_endpoint_uses_post_with_request_body() {
        let ir = ContractIr {
            types: vec![],
            endpoints: vec![ContractEndpoint {
                kind: crate::contract_ir::ContractEndpointKind::Mutation,
