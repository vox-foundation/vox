...
//!
//! The implementation moved to [`crate::lowering_shared::jsx`] so `web_ir::lower`
...
pub use crate::lowering_shared::jsx::{map_hir_type_to_ts, map_jsx_attr_name, map_jsx_tag};
