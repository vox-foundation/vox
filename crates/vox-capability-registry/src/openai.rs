...
pub fn mens_chat_parameters(capability_id: &str) -> serde_json::Value {
    match capability_id {
        "mcp.vox_oratio_transcribe" | "oratio.transcribe" => serde_json::from_str(
        ...
        "mcp.vox_oratio_status" | "oratio.status" => serde_json::from_str(
            r#"{"type":"object","additionalProperties":false}"#,
        )
        .unwrap_or_else(|_| serde_json::json!({"type":"object"})),
        "mcp.vox_oratio_listen" | "oratio.listen" => serde_json::from_str(
