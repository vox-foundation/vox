...
use std::sync::Arc;
use vox_ars_runtime::hooks::HookRegistry;
use vox_ars_runtime::runtime::ArsRuntime;
...
pub async fn run(id: &str, input_json: Option<&str>, workflow: bool) -> Result<()> {
    ...
    let skill = vox_ars_runtime::domain::ArsSkill {
        ...
        kind: vox_ars_runtime::manifest::SkillKind::Document,
        body: None,
