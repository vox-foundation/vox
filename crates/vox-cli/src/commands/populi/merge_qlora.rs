//! `vox populi merge-qlora` — fold v2 Candle QLoRA LoRA tensors into base f32 weights (subset).

use std::path::PathBuf;

use anyhow::Context;
use vox_populi::MERGE_QLORA_REJECTS_BURN_BIN;
use vox_populi::tensor::adapter_schema_v3::PopuliAdapterManifestV3;
use vox_populi::tensor::candle_qlora_merge::{QloraAdapterMetaV2, merge_qlora_v2_into_base_subset};
