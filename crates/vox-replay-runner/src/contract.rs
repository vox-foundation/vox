...
//!
//! The replay runner consumes [`vox_scientia::ro_crate::MainEntity`]; this
            ...
            arr.iter()
                ...
                .map(|(idx, f)| {
                    ...
                    let caption_hint = f
                        ...
                        .and_then(Value::as_str)
                        .map(str::to_string);
                    Ok::<_, ParseError>(vox_scientia::ro_crate::FigureProvenance {
                        path,
                        sha3_256_hex: sha,
...
mod tests {
    use super::*;
    use vox_scientia::ro_crate::{build_ro_crate_json, RoCrateMetadata};
