...
impl OrchestratorConfig {
    pub fn merge_env_overrides(&mut self) {
        fn clavis_opt(id: vox_secrets::SecretId) -> Option<String> {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorEnabled) {
            self.enabled = parse_or_warn("VOX_ORCHESTRATOR_ENABLED", &val, self.enabled);
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMaxAgents) {
            self.max_agents = parse_or_warn("VOX_ORCHESTRATOR_MAX_AGENTS", &val, self.max_agents);
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorLockTimeoutMs) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorToestubGate) {
            self.toestub_gate =
                parse_or_warn("VOX_ORCHESTRATOR_TOESTUB_GATE", &val, self.toestub_gate);
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMaxDebugIterations) {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMaxToestubDebugIterations)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMaxSocratesDebugIterations)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorSocratesGateShadow) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorSocratesGateEnforce) {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorSocratesReputationRouting)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorSocratesReputationWeight)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustGateRelaxEnabled) {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustGateRelaxMinReliability)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorLogLevel) {
            self.log_level = val;
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorFallbackSingle) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMinAgents) {
            self.min_agents = parse_or_warn("VOX_ORCHESTRATOR_MIN_AGENTS", &val, self.min_agents);
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorScalingThreshold) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorIdleRetirementMs) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorScalingEnabled) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorCostPreference) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorScalingLookback) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorResourceWeight) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorResourceCpuMult) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorResourceMemMult) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorResourceExponent) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorScalingProfile) {
            match val.to_lowercase().as_str() {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMaxSpawnPerTick) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorScalingCooldownMs) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorUrgentRebalanceThreshold)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMigrationV2Enabled) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMigrationLegacyFallback)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshControlUrl) {
            let v = val.trim();
            if v.is_empty() {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPopuliInferenceBaseUrl) {
            let v = val.trim();
            if v.is_empty() {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxMeshScopeId) {
            let v = val.trim();
            if v.is_empty() {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshPollIntervalSecs) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshHttpTimeoutMs) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRoutingExperimental)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRebalanceOnRemoteSchedulableDrop)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshTrainingRoutingExperimental)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshTrainingBudgetPressure)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteExecuteExperimental)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteExecuteReceiverAgent)
        {
            let t = val.trim();
            if t.is_empty() {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteExecuteSenderAgent)
        {
            let t = val.trim();
            if t.is_empty() {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteResultPollIntervalSecs)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteResultMaxMessagesPerPoll)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteWorkerPollIntervalSecs)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteLeaseGatingEnabled)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorMeshRemoteLeaseGatedRoles)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorChatmlStrict) {
            self.chatml_strict =
                parse_or_warn("VOX_ORCHESTRATOR_CHATML_STRICT", &val, self.chatml_strict);
        }
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningEnabled) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningRouterEnabled) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningReplanEnabled) {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningWorkflowHandoffEnabled)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningShadowMode) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorResearchModelEnabled) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningAutoModeEnabled)
        {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanningRolloutPercent) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanAdequacyShadow) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorPlanAdequacyEnforce) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorContextLifecycleShadow) {
        ...
        if let Some(val) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorContextLifecycleEnforce)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorCompletionGroundingShadow)
        {
        ...
        if let Some(val) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorCompletionGroundingEnforce)
        {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorAttentionEnabled) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorAttentionBudgetMs) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorAttentionAlertThreshold) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorAttentionInterruptCostMs) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustEwmaAlpha) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustProvisionalThreshold)
        {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustTrustedThreshold) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTrustAutoApproveMin) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTlxMental) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTlxTemporal) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTlxFrustration) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTlxTrustDiscount) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTierGateEntropyThreshold) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorTierGateMinObservations) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorInterruptionCalPlanGain) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorInterruptionCalA2AGain) {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorInterruptionCalBacklogPenalty)
        {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorAttentionTrustRoutingWeight)
        {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorRepoShardSpecializationWeight)
        {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorRepoShardValidationFailurePenalty)
        {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorRepoReduceConflictCooldownPenalty)
        {
        ...
        if let Some(v) =
            clavis_opt(vox_secrets::SecretId::VoxOrchestratorRepoReduceConflictCooldownMs)
        {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsPublishArmed) {
            self.news.publish_armed =
                parse_or_warn("VOX_NEWS_PUBLISH_ARMED", &v, self.news.publish_armed);
        }
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsSiteBaseUrl) {
            let t = v.trim();
            if t.is_empty() {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsRssFeedPath) {
            let t = v.trim();
            if t.is_empty() {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsScanRecursive) {
            self.news.scan_recursive =
                parse_or_warn("VOX_NEWS_SCAN_RECURSIVE", &v, self.news.scan_recursive);
        }
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsTwitterTextChunkMax) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxNewsTwitterTruncationSuffix) {
            let t = v.trim();
            if t.is_empty() {
        ...
        self.news.youtube_refresh_token =
            vox_secrets::resolve_secret(vox_secrets::SecretId::VoxSocialYoutubeRefreshToken)
                ...
                .filter(|s| !s.is_empty())
                .map(str::to_string);
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxSocialHnMode) {
            let t = v.trim();
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxSocialWorthinessEnforce) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxSocialWorthinessScoreMin) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxSocialChannelWorthinessFloors) {
            for pair in v.split(',') {
        ...
        self.news.bluesky_handle = clavis_opt(vox_secrets::SecretId::VoxSocialBlueskyHandle);
        self.news.bluesky_password = clavis_opt(vox_secrets::SecretId::VoxSocialBlueskyPassword);
        self.news.mastodon_token = clavis_opt(vox_secrets::SecretId::VoxSocialMastodonToken);
        self.news.mastodon_domain = clavis_opt(vox_secrets::SecretId::VoxSocialMastodonDomain);
        self.news.linkedin_token = clavis_opt(vox_secrets::SecretId::VoxSocialLinkedinAccessToken);
        self.news.discord_webhook = clavis_opt(vox_secrets::SecretId::VoxSocialDiscordWebhook);

        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorExecTimeBudgetEnabled) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorExecTimeSafetyMultiplier) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorExecTimeTimeoutRateAlert) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorExecTimeDefaultBudgetMs) {
        ...
        if let Some(v) = clavis_opt(vox_secrets::SecretId::VoxOrchestratorExecTimeHistoryWindowDays)
        {
