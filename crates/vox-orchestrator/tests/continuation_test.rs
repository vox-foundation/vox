...
fn test_continuation_engine() {
    ...
    let prompt1 =
        engine.generate_continuation(agent_id, ContinuationStrategy::Continue, 1, 0, None, None, &bus);
    ...
    let prompt2 =
        cooled_engine.generate_continuation(AgentId(2), ContinuationStrategy::Continue, 1, 0, None, None, &bus);
