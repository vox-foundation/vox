...
///
/// Generated by `cargo run -p vox-scientia-jsonschema-codegen` from
/// `contracts/scientia/*.schema.json`; clippy lints are suppressed here for
/// the same reason `dead_code` is — the generator owns the style.
