//! Request parameters, row shapes, and errors for [`crate::store::CodeStore`] (Arca on Turso).
//!
...
/// Parameters for [`crate::store::CodeStore::save_memory`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::store::CodeStore::log_interaction`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::store::CodeStore::save_snippet`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::store::CodeStore::publish_artifact`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::store::CodeStore::register_agent`].
#[derive(Debug, Clone)]
