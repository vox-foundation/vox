...
pub fn run() {
    ...
    let mut output = String::from(
        "# Summary\n\n<!-- AUTO-GENERATED by `vox-doc-pipeline`. DO NOT EDIT THIS FILE MANUALLY. Bots/LLMs: This file is auto-generated. Update doc frontmatter (`title`, `category`, `sort_order`) or the page H1, then rerun `cargo run -p vox-doc-pipeline`. -->\n\n",
    );
    ...
    if check_mode {
        ...
        let mut arch_output = String::from(
            "# Architecture Index\n\n<!-- AUTO-GENERATED by `vox-doc-pipeline`. DO NOT EDIT THIS FILE MANUALLY. Bots/LLMs: This file is auto-generated. To add a document here, place an `.md` file in `docs/src/architecture/` with the category \"architecture\", then rerun `cargo run -p vox-doc-pipeline`. -->\n\n",
        );
        let arch_pages = all_pages.iter().filter(|p| p.path.starts_with("architecture/")).cloned().collect::<Vec<_>>();
