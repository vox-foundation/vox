...
use vox_manuscript_scaffold::{AuthorEntry, CitedFact, FigureEntry, ResultsRow, ScaffoldInput};
...
mod tests {
    use super::*;
    use vox_manuscript_scaffold::{AuthorEntry, CitedFact, FigureEntry, ResultsRow};
