...
//! ([`crate::lower`]), not necessarily raw source spelling. Prefer [`vox_ast::span::Span`] on each node for
...
/// Type representation in HIR (resolved from [`vox_ast::types::TypeExpr`]).
