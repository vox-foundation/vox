...
#[test]
#[ignore = "dispatches to an installed MlBackend plugin (vox plugin install mens-candle-metal / -cuda / -cpu); run with --ignored. Merge math is covered hermetically by vox-plugin-mens-candle-core merge::tests"]
