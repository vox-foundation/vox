...
//!
//! The pure-data result types ([`BuildDependencyShape`], [`BuildHealthSummary`],
//! [`CrateSample`], [`RegressionRow`]) live in [`vox_db_types`] and are re-exported
//! here for back-compat. The query operations stay on [`crate::VoxDb`].
