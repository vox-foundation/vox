//! Arca CRUD for Mens cloud GPU dispatch tables.
//!
//! Tables: `cloud_dispatch_log`, `training_throughput_profiles`, `local_train_log`.
//! Schema defined in `crates/vox-db/src/schema/domains/mens_cloud.rs`.
...
impl crate::VoxDb {
    ...
    /// Summarize completed cloud and local jobs for `vox mens status --cloud`.
