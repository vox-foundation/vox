//! Request parameters, row shapes, and errors for [`crate::arca_store::CodeStore`] (Arca on Turso).
//!
...
//!
//! **Pattern:** Parameter structs that mirror a `CodeStore::…` method include a rustdoc link to that
...
/// Parameters for [`crate::arca_store::CodeStore::save_memory`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::arca_store::CodeStore::log_interaction`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::arca_store::CodeStore::save_snippet`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::arca_store::CodeStore::publish_artifact`].
#[derive(Debug, Clone)]
...
/// Parameters for [`crate::arca_store::CodeStore::register_agent`].
#[derive(Debug, Clone)]
