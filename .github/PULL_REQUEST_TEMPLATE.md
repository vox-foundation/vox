...
## Ludus / gamify (if applicable)

- [ ] New event `type` has **`base_reward`** and **`process_event_rewards`** companion/quest/counter behavior _or_ is documented as policy-only in [`docs/src/architecture/agent-event-kind-ludus-matrix.md`](../docs/src/architecture/agent-event-kind-ludus-matrix.md).
...
- [ ] Env vars: [`docs/src/reference/env-vars.md`](../docs/src/reference/env-vars.md) Ludus section if new `VOX_LUDUS_*` knobs were added.
