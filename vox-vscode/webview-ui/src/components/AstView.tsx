...
export const AstView = ({ ast = MOCK_AST, activeFile }: { ast?: any, activeFile?: string }) => {
  return (
    <div className="h-full flex flex-col bg-[#09090b]">
       <header className="px-10 py-8 border-b border-white/5 bg-white/[0.01]">
          ...
          <div className="flex items-center gap-6">
             ...
             <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Active: {activeFile || 'No file open'}</span>
          </div>
       </header>
       ...
       <div className="flex-1 overflow-hidden grid grid-cols-12">
          ...
          <div className="col-span-7 bg-white/[0.005] p-10 overflow-y-auto">
             ...
             <div className="glass rounded-[2rem] border border-white/5 p-8 font-mono text-xs leading-relaxed text-zinc-400">
                <pre>{JSON.stringify(ast?.items?.[0] || ast, null, 2)}</pre>
             </div>
          </div>
       </div>
    </div>
