---
title: "External repositories and workspace SSOT"
...
- [`orchestration-unified-ssot.md`](./orchestration-unified-ssot.md) — MCP/DeI plan alignment, migration flags, benchmark telemetry env.
- [`mesh-ssot.md`](./mesh-ssot.md) — `VOX_MESH_*` contract, local registry, HTTP control plane.
