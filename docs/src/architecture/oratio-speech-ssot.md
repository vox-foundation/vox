...
- `AGENTS.md`, `docs/src/ref-cli.md`, [`populi-training-ssot.md`](populi-training-ssot.md), **this file**
...
- **Native fine-tuning** (Burn LoRA / `vox populi train`): [`populi-training-ssot.md`](populi-training-ssot.md).
