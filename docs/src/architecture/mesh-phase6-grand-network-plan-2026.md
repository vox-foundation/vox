...
- **Auto-generated file discipline.** No edits to `SUMMARY.md`, `architecture-index.md`, or `feed.xml`. `research-index.md` is retired (archived 2026-09). The Starlight sidebar is the browse surface. `architecture-index.md` stays gitignored.
