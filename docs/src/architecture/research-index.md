...
- [FFScript Linter Engine Design (2026-04-23)](ffscript-linter-design-2026.md) — TypeScript interfaces and default rule catalogue for the pluggable FFScript linter (T-046–T-050, T-035–T-039 collapsed). Covers LintRule/LintResult/LintEngine types, 11 default rules with per-rule acceptance criteria, wizard health-bar integration, publish-gate integration, CLI design, and autofix ordering. Subsumes T-059 (symbolic executor) via the unreachable-node and infinite-loop rules.
