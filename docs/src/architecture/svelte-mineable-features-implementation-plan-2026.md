...
| F | M2 — Typed parametric fragment primitive | **Defer** until Phase-6 primitives stabilize (avoids designing fragments against a deprecated authoring surface) | TASK-6.1 + ADR-033 | Yes |
