...
|---|---|---|---|---|
| A | M5 — `vox_validate_source` + autofix surfacing | **✅ Shipped** ([8ae08edab](https://github.com/anthropics/vox)). `DiagnosticInfo.{code,fixes}` plumbed end-to-end; new `vox_validate_source` tool in registry/dispatch/http_gateway. | — | No |
