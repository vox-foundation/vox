...
If your runner cannot run DinD, the smoke job fails soft; keep **`mesh-compose-config`** green for compose YAML validation. See [deployment compose SSOT](../reference/deployment-compose.md).
