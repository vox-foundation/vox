...
| [006](006-populi-full-graph-qlora-qlora-rs.md) | **Populi full-graph Candle QLoRA (qlora-rs)** |
| [007](007-qlora-rs-multi-layer-training-api.md) | **qlora-rs 1.0.5 multi-layer training API gate** |
| [008](008-mesh-transport.md) | **Mesh control plane (HTTP; TLS at edge)** |
| [009](009-mesh-hosted-baas.md) | **Hosted mesh / BaaS (future trust model)** |
