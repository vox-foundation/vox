...
4. **OpenAPI** for the **local** API lives at [`schemas/mens-control-plane.openapi.yaml`](../../../schemas/mens-control-plane.openapi.yaml); a hosted product may extend with versioned paths under a separate spec revision.
