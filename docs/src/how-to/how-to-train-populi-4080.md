...
description: "Official documentation for How To: Train Populi on RTX 4080 Super for the Vox language. Detailed technical reference, architecture guides"
category: "how-to"
...
**Canonical contracts, backends, and regression commands:** [Populi native training SSOT](../reference/populi-training.md). This page is a **step-by-step runbook** for RTX 4080 Super; do not duplicate SSOT tables here.
...
5. **Merge / serve**: Candle merge is **`vox populi merge-qlora`** (f32 shard subsets); **`vox populi serve`** stays Burn-only — see SSOT [Merge / export](../reference/populi-training.md#merge--export--inference).
...
- [How To: Publish Populi to Hugging Face](../reference/populi-cloud-gpu.md)
