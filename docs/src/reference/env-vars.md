...
| `VOX_MCP_LLM_COST_EVENTS` | When truthy, enables LLM cost telemetry emission ([`infer`](../../../crates/vox-orchestrator/src/mcp_tools/llm_bridge/infer.rs)). Trust SSOT: [telemetry-trust-ssot](../architecture/telemetry-trust-ssot.md). |
