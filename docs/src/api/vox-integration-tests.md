---
title: "Crate API: vox-integration-tests"
description: "Official documentation for Crate API: vox-integration-tests for the Vox language. Detailed technical reference, architecture guides, and "
category: "reference"
