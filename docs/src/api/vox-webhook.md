---
title: "Crate API: vox-webhook"
description: "Official documentation for Crate API: vox-webhook for the Vox language. Detailed technical reference, architecture guides, and implementa"
category: "reference"
