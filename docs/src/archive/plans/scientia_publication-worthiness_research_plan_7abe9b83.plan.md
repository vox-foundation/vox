...
- CLI/MCP control-plane: [`crates/vox-cli/src/commands/db_cli/publication_subcommands.rs`](crates/vox-cli/src/commands/db_cli/publication_subcommands.rs), [`crates/vox-orchestrator/src/mcp_tools/tools/scientia_tools/lifecycle.rs`](crates/vox-orchestrator/src/mcp_tools/tools/scientia_tools/lifecycle.rs)
