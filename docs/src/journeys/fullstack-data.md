...
- **[Explanation: Vox Web Architecture and TypeScript Interop](../archive/research-2026-q1/vox-web-stack-ssot.md)**: SSOT explaining the compilation boundaries between Vox AST and `.tsx` file emission.
