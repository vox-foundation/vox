...
- [Building Resilient AI Agents](journeys/ai-agents.md)
- [Reliable Background Workflows](journeys/durable-workflows.md)
- [One-File Full-Stack Data](journeys/fullstack-data.md)
- [Native Rust LLM Training](journeys/native-training.md)
...
- [Agentic User Journeys](architecture/agentic-user-journeys.md)
...
- [Plan adequacy (thin plans & rollout)](architecture/plan-adequacy.md)
...
- [Compiler diagnostics ergonomics](architecture/compiler-diagnostics-ergonomics.md)
...
- [Language surface SSOT](architecture/language-surface-ssot.md)
...
- [OpenAPI contract SSOT](architecture/openapi-contract-ssot.md)
- [Outbound HTTP policy](architecture/outbound-http-policy.md)
...
- [ADR 020: Populi mesh scaling transport default](adr/020-populi-mesh-scaling-transport-default.md)
