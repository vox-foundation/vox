...
- [Scientia publication: operator inputs vs derived fields](how-to/scientia-publication-operator-inputs.md)
...
- [Contributing — parser & HIR](how-to/how-to-contribute-parser-hir.md)
- [Contributing — Populi](how-to/how-to-contribute-populi.md)
- [Contributing — Mens training](how-to/how-to-contribute-mens.md)
...
- [Scholarly digest-bound approval invariants](architecture/scholarly-digest-approval-invariants.md)
- [Scholarly external jobs schema plan](architecture/scholarly-external-schema-plan.md)
...
- [Script surface audit (Python / shell migration)](architecture/script-surface-audit.md)
- [Ludus: scope and non-goals](architecture/ludus-non-goals.md)
- [Ludus integration contract (producers)](architecture/ludus-integration-contract.md)
- [AgentEventKind → Ludus matrix](architecture/agent-event-kind-ludus-matrix.md)
...
- [Crate API: vox-ludus](api/vox-ludus.md)
- [Crate API: vox-gamify](api/vox-gamify.md) (legacy crate name; user-facing CLI is `vox ludus`)
...
- [Docker image baselines](reference/docker-image-baselines.md)
...
- [VS Code extension ↔ MCP compatibility](reference/vscode-mcp-compat.md)
- [Mens Coordination & Database Write Safety](reference/mens-coordination.md)
- [Mens SSOT (CPU-first)](reference/mens.md)
- [Populi HTTP mesh & A2A (SSOT)](reference/populi.md)
