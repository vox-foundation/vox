...
## 2. Prerequisites — the 4 codegen-TS bugs in [PR #78's plan](docs/superpowers/plans/2026-05-08-codegen-ts-bugs-blocking-tracker.md)

Before Path C's emit changes are valuable, the existing TS codegen needs to produce *correct* output. Four bugs documented in `docs/superpowers/plans/2026-05-08-codegen-ts-bugs-blocking-tracker.md`:
