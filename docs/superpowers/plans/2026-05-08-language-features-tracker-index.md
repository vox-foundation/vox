...
| 3 | [match-arm statement bodies](./2026-05-08-language-match-arm-statements.md) | Ergonomic everywhere; called out in the tracker code today | Tiny, ergonomic, removes repeated workarounds. Land any time. |
| 4 | [string utilities (split / slice / char_at / index_of / starts_with / ends_with)](./2026-05-08-language-string-utils.md) | Ad-hoc parsing, content sniffing, future Phase 4 export glue | Tiny pure additions; land any time. |
