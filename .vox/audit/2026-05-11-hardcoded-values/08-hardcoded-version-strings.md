...
**Why it matters**: Duplicated API version strings drift from the single workspace version SSOT.

**Fix** (centralize-in-contract): Derive API route version from one module or contract-owned constant; avoid sprinkling "v1" strings.

**SSOT**: `contracts/index.yaml`

**Verify**: `rg -nF "\"0.3.0\"" "contracts/config/env-vars.v1.yaml"`
...
**Verify**: `rg -nF "\"0.5.0\"" "contracts/config/env-vars.v1.yaml"`
