...
- **Docs (research):** [`docs/src/archive/research-2026-q1/terminal-exec-policy-research-findings-2026.md`](docs/src/archive/research-2026-q1/terminal-exec-policy-research-findings-2026.md) (archived) — PowerShell-first agent shells, Cursor/Gemini/Codex policy evidence, allowlist bypass lessons, alignment with operations SSOT; linked from `SUMMARY.md`, research/architecture indexes, `AGENTS.md`, `GEMINI.md`, and agent instruction docs.
