...
# Requires: release `vox` with gpu,mens-candle-cuda; VS env already used for the build.
...
#
# Usage:
#   pwsh scripts/mens/cursor_background_train_example.ps1
#   Get-Content mens/runs/logs/train_*.log -Wait -Tail 20
